...
class SearchFeatures:
    ...
    def _execute_search(self, query):
        ...
        self.search_cache = {}
        self.search_offsets = {'songs': 0, 'albums': 0, 'artists': 0, 'music_videos': 0}
        self.is_loading_more = {'songs': False, 'albums': False, 'artists': False, 'music_videos': False}
        self.is_initial_loading = {'songs': True, 'albums': True, 'artists': True, 'music_videos': True, 'top_results': True}
        self.no_more_results = {'songs': False, 'albums': False, 'artists': False, 'music_videos': False}
    ...
    def _populate_category_tab(self, category, items):
        ...
        else: # grid for other categories
            layout = QGridLayout(container)
            layout.setProperty("reflowable", True)
            layout.setSpacing(10)
            cols = max(1, self.main_content_container.width() // 200)
